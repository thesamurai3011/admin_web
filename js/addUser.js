...
var text5 = document.getElementById("name");
    ...
    ref.orderByChild("email").equalTo(text1.value).once("value", snapshot => {
        if(text1.value == "" || text6.value == "" || text3.value == "" || text4.value == "" || text5.value == ""){
            ...
            if(snapshot.exists()){
                ...
                var newUser = ref.child(md5(text1.value));
                newUser.set({
                    personID: text6.value,
                    email: text1.value,
                    name: text5.value,
                    phone: text3.value,
                    address: text4.value,
                });
                var email = text1.value;
                var password = text2;
                ...
                test.once("value", function (snapshot) {
                    ...
                    firebase.database().ref('Component/' + component).set({
                        Sensor: {
                            0: {
                                deviceID: "sensor_" + (count * 2),
                                mode: 2,
                                name: "sensor_" + (count * 2),
                                position: 0,
                            },
                            1: {
                                deviceID: "sensor_" + ( count * 2 + 1),
                                mode: 2,
                                name: "sensor_" + ( count * 2 + 1),
                                position: 1,
                            },
                        },
                        Servo: {
                            0: {
                                deviceID: "servo_" + (count),
                                name: "Cua chinh",
                                state: false,
                            },
                        },
